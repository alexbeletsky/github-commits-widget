...
element.append('</ul>');element.append('<br/><h5>github commit widget by <a href="https://github.com/alexanderbeletsky">Alexander Beletsky</a></h5>');function avatar(email){var emailHash=hex_md5(email);return'<img src="http://www.gravatar.com/avatar/'+emailHash+'?s=20"/>';}
